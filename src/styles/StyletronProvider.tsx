...
// COPIED FROM:
// https://github.com/patte/next13-styletron-baseui-colorScheme/blob/main/lib/ui/StyletronProvider.tsx
...
function SSRStyletronProvider({ children }: { children: React.ReactNode }) {
  ...
  return <Provider value={styletron}>{children}</Provider>;
}

export { SSRStyletronProvider };
